...
(function($) {
    ...
    //var goToul = $(".resize");
    //var goTem =$(".tempWrap")
    //var resetFun = function(){ goTo.each(function(){  $(this).width( $(window).width() ) }); }
    //resetFun();
    //var resetUl = function(){ goToul.each(function(){  $(this).width( $(window).width() * 3 ) }); }
    //resetUl();
    //var resetTem = function(){ goTem.each(function(){  $(this).width( $(window).width() ) }); }
    //resetTem();
    //var resetHei = function(){ goTo.each(function(){  $(this).height( $(window).height() ) }); }
    //resetHei();
    //$(window).resize(function(){ resetFun(); resetUl();});
})(jQuery);
